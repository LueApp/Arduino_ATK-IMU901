...
#define imu901_uart_receive(data)	*data=Serial1.read() /*!< 串口获取接收数据API */
// #define imu901_uart_send(data, len)		Serial1.print("data") /*!< 串口i发送数据API */
#define imu901_uart_send(data, len)		for(int i=0;i<len;i++)Serial1.print((uint8_t)data[i]); /*!< 串口i发送数据API */
